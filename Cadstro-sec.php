                ...
                <div class="collapse navbar-collapse" id="navbarSite">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                        <a href="#" class="dropdown-item"> Secretarias </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                    <a href="#" class="dropdown-item"> Prefeitura </a>
                                    <a href="#" class="dropdown-item"> Secretaria de Educação  </a>
                                    <a href="#" class="dropdown-item"> Governo do Estado  </a>
                            </div>
                        </li>
                    </ul>
                </div>
